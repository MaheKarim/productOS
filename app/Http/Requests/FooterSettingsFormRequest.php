...
class FooterSettingsFormRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'linkedin_url.string' => 'The LinkedIn URL must be text.',
            'twitter_url.string' => 'The Twitter URL must be text.',
            'github_url.string' => 'The GitHub URL must be text.',
            'email.email' => 'The email must be a valid email address.',
            'column1_links.*.url' => 'All links in column 1 must be text.',
            'column2_links.*.url' => 'All links in column 2 must be text.',
            'column3_links.*.url' => 'All links in column 3 must be text.',
