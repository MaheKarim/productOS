...
@section('page-title', 'Edit Voice Capture')
...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-10">
            ...
            <h3 class="text-3xl font-black text-slate-900 tracking-tight">Edit Client Voice</h3>
            <p class="text-slate-500 mt-2">Update the documented impact of your work.</p>
        </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea name="feedback" rows="6"
                                    ...
                                    placeholder="What did the client say about your collaboration?">{{ old('feedback', $testimonial->feedback) }}</textarea>
                                @error('feedback')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="rating"
                                        ...
                                        @for ($i = 5; $i >= 1; $i--)
                                            <option value="{{ $i }}"
                                                {{ old('rating', $testimonial->rating) == $i ? 'selected' : '' }}>{{ $i }} Stars
                                            </option>
                                        @endfor
                                    </select>
                                </div>
                ...
                <div class="space-y-8">
                            ...
                            <div
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="is_active" value="1"
                                        {{ old('is_active', $testimonial->is_active) ? 'checked' : '' }} class="sr-only peer">
                                    <div
                    ...
                    <div class="bg-white rounded-[2.5rem] p-8 border border-slate-200/60 shadow-sm text-center">
                        ...
                        @if ($testimonial->avatar_image)
                            <div class="mb-4">
                                <img src="{{ Storage::url($testimonial->avatar_image) }}" alt="Current Avatar" class="w-20 h-20 rounded-full mx-auto object-cover border-2 border-slate-200">
                                <p class="text-[10px] text-slate-400 mt-2">Current Avatar</p>
                            </div>
                        @endif
                        ...
                        <div
                            ...
                            <div class="text-center group-hover:scale-105 transition-transform">
                                ...
                                <p class="text-[10px] font-bold text-slate-500">Upload New Avatar</p>
                            </div>
                        </div>
