...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-lg font-semibold text-teal-900">Edit Hero Section</h3>
            <a href="{{ route('admin.hero.show', $hero) }}" class="text-primary hover:text-teal-900 text-sm font-medium">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="subtitle" rows="3"
                            ...
                            placeholder="Enter subtitle text">{{ old('subtitle', $hero->subtitle) }}</textarea>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="order" value="{{ old('order', $hero->order) }}" min="0"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        @if ($hero->background_image)
                            <div class="mb-3">
                                <img src="{{ $hero->background_image_url }}" alt="Current background"
                    ...
                    <div>
                        ...
                        @if ($hero->profile_image)
                            <div class="mb-3">
                                <img src="{{ $hero->profile_image_url }}" alt="Current profile"
                                    class="w-full h-32 object-cover rounded-lg">
                                <p class="text-xs text-slate-500 mt-1">Current image</p>
                            </div>
                        @endif
            ...
            <div class="border-t border-gray-100 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="stat1_icon" value="{{ old('stat1_icon', $hero->stat1_icon) }}"
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                ...
                                <input type="text" name="stat1_value"
                    ...
                    <div class="space-y-2">
                        <label class="block text-xs font-medium text-slate-600">Icon (FontAwesome)</label>
                        <input type="text" name="stat2_icon" value="{{ old('stat2_icon', $hero->stat2_icon) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                <label class="block text-xs font-medium text-slate-600">Value</label>
                                <input type="text" name="stat2_value"
                    ...
                    <div class="space-y-2">
                        <label class="block text-xs font-medium text-slate-600">Icon (FontAwesome)</label>
                        <input type="text" name="stat3_icon" value="{{ old('stat3_icon', $hero->stat3_icon) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                <label class="block text-xs font-medium text-slate-600">Value</label>
                                <input type="text" name="stat3_value"
            ...
            <div class="border-t border-gray-100 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="meta_title" value="{{ old('meta_title', $hero->meta_title) }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" rows="2"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
                            placeholder="SEO description for search engines">{{ old('meta_description', $hero->meta_description) }}</textarea>
                    </div>
                </div>
            </div>
