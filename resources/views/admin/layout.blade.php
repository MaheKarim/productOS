            ...
            <div class="flex flex-col flex-grow pt-8 overflow-y-auto">
                ...
                <nav class="flex-1 px-4 space-y-1" id="sidebar-menu">
                    ...
                    <a href="{{ route('admin.settings.prompts') }}"
                        class="menu-item group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-soft {{ request()->routeIs('admin.settings.prompts') ? 'sidebar-item-active' : 'hover:bg-slate-800/50 hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.notice-bars.index') }}"
                        ...
                        <i data-lucide="megaphone"
                            class="mr-3 w-5 h-5 {{ request()->routeIs('admin.notice-bars.*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-indigo-400' }}"></i>
                        Notice Bars
                    </a>
