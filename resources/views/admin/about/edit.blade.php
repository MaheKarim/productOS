...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-lg font-semibold text-teal-900">Edit About Section</h3>
            <a href="{{ route('admin.about.show', $about) }}" class="text-primary hover:text-teal-900 text-sm font-medium">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="order" value="{{ old('order', $about->order) }}" min="0"
            ...
            <div class="border-t border-gray-100 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="philosophy1_title"
                            value="{{ old('philosophy1_title', $about->philosophy1_title) }}"
                        ...
                        <textarea name="philosophy1_description" rows="2"
                            ...
                            placeholder="Description">{{ old('philosophy1_description', $about->philosophy1_description) }}</textarea>
                    </div>

                    <div class="space-y-2">
                        <label class="block text-xs font-medium text-slate-600">Philosophy 2</label>
                        <input type="text" name="philosophy2_title"
                            value="{{ old('philosophy2_title', $about->philosophy2_title) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Title">
                        <textarea name="philosophy2_description" rows="2"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
                            placeholder="Description">{{ old('philosophy2_description', $about->philosophy2_description) }}</textarea>
                    </div>

                    <div class="space-y-2">
                        <label class="block text-xs font-medium text-slate-600">Philosophy 3</label>
                        <input type="text" name="philosophy3_title"
                            value="{{ old('philosophy3_title', $about->philosophy3_title) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Title">
                        <textarea name="philosophy3_description" rows="2"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
                            placeholder="Description">{{ old('philosophy3_description', $about->philosophy3_description) }}</textarea>
                    </div>

                    <div class="space-y-2">
                        <label class="block text-xs font-medium text-slate-600">Philosophy 4</label>
                        <input type="text" name="philosophy4_title"
                            value="{{ old('philosophy4_title', $about->philosophy4_title) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Title">
                        <textarea name="philosophy4_description" rows="2"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
                            placeholder="Description">{{ old('philosophy4_description', $about->philosophy4_description) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="border-t border-gray-100 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="work_item1" value="{{ old('work_item1', $about->work_item1) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Enter work item">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-slate-600 mb-1">Work Item 2</label>
                        <input type="text" name="work_item2" value="{{ old('work_item2', $about->work_item2) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Enter work item">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-slate-600 mb-1">Work Item 3</label>
                        <input type="text" name="work_item3" value="{{ old('work_item3', $about->work_item3) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Enter work item">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-slate-600 mb-1">Work Item 4</label>
                        <input type="text" name="work_item4" value="{{ old('work_item4', $about->work_item4) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Enter work item">
                    </div>
                </div>
            ...
            <div class="border-t border-gray-100 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="core_value1" value="{{ old('core_value1', $about->core_value1) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Enter core value">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-slate-600 mb-1">Core Value 2</label>
                        <input type="text" name="core_value2" value="{{ old('core_value2', $about->core_value2) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Enter core value">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-slate-600 mb-1">Core Value 3</label>
                        <input type="text" name="core_value3" value="{{ old('core_value3', $about->core_value3) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Enter core value">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-slate-600 mb-1">Core Value 4</label>
                        <input type="text" name="core_value4" value="{{ old('core_value4', $about->core_value4) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Enter core value">
                    </div>
                </div>
            ...
            <div class="border-t border-gray-100 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="meta_title" value="{{ old('meta_title', $about->meta_title) }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" rows="2"
                            ...
                            placeholder="SEO description for search engines">{{ old('meta_description', $about->meta_description) }}</textarea>
                    </div>
                </div>
            </div>
