        ...
        <div class="grid grid-cols-1 gap-10">
                                ...
                                <div class="flex flex-col items-center gap-4">
                                    <div class="relative group">
                                        <div
                                            ...
                                            @else
                                                <div
                                                    class="w-full h-full flex items-center justify-center text-slate-300 text-4xl bg-slate-100">
            ...
            <div class="bg-white rounded-2xl shadow-premium border border-slate-100 overflow-hidden">
                <div class="p-8 border-b border-slate-100">
                    ...
                    <p class="mt-1 text-gray-500 ml-14">Ensure your account is using a long, random password to stay secure.
                    </p>
                </div>
