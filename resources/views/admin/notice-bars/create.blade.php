...
@section('title', 'Create Notice Bar')

@section('page-title', 'Create Notice Bar')
...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-bold text-slate-900">New Announcement</h2>
                <p class="text-sm text-slate-500">Create a new notice bar for the dashboard.</p>
            </div>
        </div>

        <form action="{{ route('admin.notice-bars.store') }}" method="POST" class="space-y-6">
            @csrf
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="message" id="message" rows="3" required
                            ...
                            placeholder="Enter the main content of your notice..."></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="mt-6 space-y-3">
                    ...
                    <label
                        ...
                        <div class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="dismissible" value="1" class="sr-only peer" checked>
                            <div
